...
// production-jobs.json shares the pjob_ namespace (see job-identity.js).
const SHARED_NAMESPACE_FILES = ["production-jobs.json"];

function allocateJobId(jobs) {
  const sources = [jobs];
