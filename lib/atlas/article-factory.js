...
import { isValidUrl, isPublicImageUrl } from "./revenue-layout-engine.js";
import { ATLAS_CHANNEL_ID, bindVisualAssetsToChannel, stampChannelIdentity } from "./character-channel-policy.js";
...
export function buildArticleFromMaster(master, { id, status = "written" } = {}) {
  ...
  return stampChannelIdentity({
    ...
    visualAssets: bindVisualAssetsToChannel(master.visualAssets, ATLAS_CHANNEL_ID.GLOBAL_BLOGGER),
