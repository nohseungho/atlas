...
test("the 5 wellness axes are registered as real ATLAS content axes", () => {
  ...
  // The original 10 travel axes are all still there. The total is not asserted
  // here — a new category legitimately grows it (see disaster-scope.test.mjs).
  assert.ok(CONTENT_AXES.length >= 15);
