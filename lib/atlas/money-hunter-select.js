...
// blog_001 runs two clusters: the original travel-insurance/travel-health one
// and Travel Wellness & Everyday Fitness. The wellness tokens are listed
// explicitly rather than loosened into a catch-all, so a K-Beauty or finance
// candidate still fails the niche gate exactly as before.
const NICHE_BLOG = {
  blog_001: [
