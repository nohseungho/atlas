...
// blog_001 runs three clusters: the original travel-insurance/travel-health
// one, Travel Wellness & Everyday Fitness, and Disaster Preparedness &
// Emergency Essentials. The tokens are listed explicitly rather than loosened
// into a catch-all, so a K-Beauty or finance candidate still fails the niche
// gate exactly as before.
const NICHE_BLOG = {
  blog_001: [
    "travel", "insurance", "trip", "health", "safety", "abroad", "overseas",
    "wellness", "fitness", "posture", "stretch", "workout", "pilates",
    "mobility", "dumbbell", "resistance band", "desk", "shoulder", "neck",
    "disaster", "emergency", "preparedness", "flood", "landslide", "earthquake",
    "hurricane", "typhoon", "storm", "wildfire", "evacuation", "outage",
    "go-bag", "first aid",
  ],
