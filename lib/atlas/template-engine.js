...
// ─── Locale Detection (Korean keyword text vs global/English) ────────────────

const HANGUL_PATTERN = /[가-힣]/;

export function detectLocale(keywordText) {
  const text = keywordText || "";
  return HANGUL_PATTERN.test(text)
    ? { languageCode: "ko", language: "Korean", targetCountry: "Korea" }
    : { languageCode: "en", language: "English", targetCountry: "USA" };
}
