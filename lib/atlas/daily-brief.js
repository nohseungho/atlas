...
export const ARTICLE_SECTIONS = [
  ...
  { id: "decisionTable", heading: "Situation-by-situation comparison or decision table", required: true, note: "A real HTML <table> comparing scenarios/options — not a restatement of the prose." },
