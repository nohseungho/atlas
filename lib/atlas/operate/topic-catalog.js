...
export const KOREA_TOPICS = Object.freeze([
  {
    ...
    cards: {
      why: {
        title: "가격보다 먼저 정할 것",
        columns: [
          ["관계", "공식적인 사이인지, 서로의 생활을 아는 사이인지"],
          ["보관 여건", "그 집 냉장고에 자리가 있는지"],
          ["받는 시점", "명절 전에 도착해야 하는지"],
        ],
        footer: "이 셋이 정해지면 후보가 저절로 줄어듭니다.",
      },
      how: {
        title: "받는 사람별 기준",
        columns: [
          ["직장·거래처", "취향을 모르니 호불호가 적은 쪽으로"],
          ["친척·지인", "생활을 아는 사이라 실제로 쓰는 것으로"],
          ["부모님", "보관 여건이 먼저, 대용량 신선식품은 피하기"],
        ],
        footer: "관계가 다르면 같은 금액도 다른 선물이 됩니다.",
      },
      checklist: {
        title: "주문 전 체크리스트",
        columns: [
          ["순서", "가격보다 관계·보관·시점을 먼저"],
          ["양", "많이보다 다 쓸 수 있는 양으로"],
          ["배송", "명절 배송 마감일 확인"],
          ["조건", "신선식품은 교환·환불 조건 확인"],
        ],
        footer: "주소와 연락처는 결제 직전에 한 번 더 봅니다.",
      },
    },
    season: [8, 9, 10],
  ...
  },
  {
    ...
    cards: {
      why: {
        title: "가을 습도가 방마다 다른 이유",
        columns: [
          ["외벽·창가", "실내 평균보다 차가워 수증기가 먼저 맺힙니다"],
          ["북향 방", "공기가 거의 움직이지 않습니다"],
          ["장롱 안쪽", "같은 자리에서 곰팡이가 반복됩니다"],
        ],
        footer: "집 전체가 아니라 특정 자리의 문제입니다.",
      },
      how: {
        title: "돈 안 드는 순서부터",
        columns: [
          ["1. 환기", "아침 5~10분, 마주 보는 창을 함께"],
          ["2. 가구 배치", "외벽에 붙은 가구를 5cm 이상 띄우기"],
          ["3. 장비", "그래도 축축한 방에만 제습기 고려"],
        ],
        footer: "순서를 바꾸면 장비를 사고도 곰팡이가 다시 생깁니다.",
      },
      checklist: {
        title: "오늘의 체크리스트",
        columns: [
  ...
  },
  {
    ...
    cards: {
      why: {
        title: "첫 가동 전 점검 세 가지",
        columns: [
          ["압력", "압력계가 권장 범위 아래면 물 보충"],
          ["분배기", "잠가둔 방이 있으면 순환 효율이 떨어집니다"],
          ["온수", "미지근하거나 널뛰면 점검 신호"],
        ],
        footer: "켜기 전 3분이 한 겨울 난방비를 바꿉니다.",
      },
      how: {
        title: "실내온도와 온돌온도는 다릅니다",
        columns: [
          ["실내온도", "방 안 센서 기준으로 켜고 끕니다"],
          ["온돌온도", "바닥으로 나가는 물 온도 기준"],
          ["바닥이 찰 때", "실내온도 말고 온돌온도를 손봅니다"],
        ],
        footer: "실내온도만 올리면 보일러가 쉬지 않습니다.",
      },
      checklist: {
        title: "오늘의 체크리스트",
        columns: [
    ...
    cards: {
      why: {
        ...
        columns: [
          ["가장 차가운 곳", "안쪽 아래칸"],
          ["가장 따뜻한 곳", "문쪽 선반"],
          ["그래서", "우유·달걀을 문쪽에 두면 가장 불리합니다"],
        ],
        footer: "상하기 쉬운 것일수록 안쪽 아래로 보냅니다.",
      },
      how: {
        title: "자리를 정하는 기준",
        columns: [
          ["안쪽 아래", "육류·어류처럼 온도에 민감한 재료"],
          ["중간칸", "조리한 음식과 유제품"],
          ["채소칸", "잎·뿌리채소, 숙성 가스 내는 과일은 분리"],
        ],
        footer: "문쪽에는 장류처럼 온도 변화에 강한 것만.",
      },
      checklist: {
        title: "오늘의 체크리스트",
        columns: [
