...
export const KOREA_TOPICS = Object.freeze([
  {
    ...
    sceneIntents: {
      info_why: "Suho at a desk with a notepad, deciding who each Chuseok gift is for before looking at prices",
      info_how: "Suho comparing a shelf-stable gift box against a chilled fresh-food box in a shop aisle",
      info_checklist: "Suho at a low table checking a delivery cut-off date on his phone beside a wrapped box",
    },
    season: [8, 9, 10],
  ...
  },
  {
    ...
    sceneIntents: {
      info_why: "Suho beside a window in a Korean apartment where condensation has formed along the frame in the early morning",
      info_how: "Suho pulling a wardrobe a few centimetres away from an outside wall to open an air gap behind it",
      info_checklist: "Suho at a low living-room table checking a small humidity meter next to a mug",
    },
    season: [9, 10, 11],
  ...
  },
  {
    ...
    sceneIntents: {
      info_why: "Suho reading the pressure gauge on a wall-mounted home boiler before the first cold night",
      info_how: "Suho opening the manifold valves in a utility cupboard so every room circulates",
      info_checklist: "Suho at a low table pointing at the gap under a front door where heated air escapes",
    },
    season: [10, 11, 12],
  ...
  },
  {
    ...
    sceneIntents: {
      info_why: "Suho with the fridge door open, feeling the temperature difference between the door shelf and the back of the bottom shelf",
      info_how: "Suho moving vegetables into the crisper drawer and setting apples aside in a separate bowl",
      info_checklist: "Suho at a low table writing an opened-on date on a container lid",
    },
...
export const GLOBAL_TOPICS = Object.freeze([
  {
    ...
    sceneIntents: {
      featured: "Miji at a hotel desk realising her passport is missing from her bag",
      context: "Miji walking up to an embassy reception counter with a document folder",
      comparison: "Miji seated at a consular desk comparing an emergency travel document against a full passport",
      checklist: "Miji crouched beside her suitcase, laying out ID copies and a police report",
      closing: "Miji by a departure-board window with her phone, waiting to rebook",
    },
  ...
  },
  {
    ...
    sceneIntents: {
      featured: "Miji at a travel-planning desk holding her passport open at the photo page beside a wall calendar",
      context: "Miji walking through an airport border-control hall with a shoulder bag",
      comparison: "Miji seated at a table comparing two passports with different expiry dates laid side by side",
      checklist: "Miji crouched beside an open carry-on case, counting the blank pages in her passport",
      closing: "Miji pausing by an airport window with her phone, checking renewal processing times",
    },
  ...
  },
  {
    ...
    sceneIntents: {
      featured: "Miji at a desk holding a laptop charger, reading the small input text on the power brick",
      context: "Miji walking into a hotel room with a small bag of adapters",
      comparison: "Miji seated at a table with a plug adapter and a voltage converter set out side by side",
      checklist: "Miji crouched beside an open suitcase, sorting chargers into a pouch",
      closing: "Miji by a window charging her phone from a single wall socket",
    },
...
export function findTopic(topicId) {
  return KOREA_TOPICS.find((t) => t.id === topicId) || GLOBAL_TOPICS.find((t) => t.id === topicId) || null;
}
