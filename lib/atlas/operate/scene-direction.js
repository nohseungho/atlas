...
export const HAIR = Object.freeze({
  DOWN: "long straight hair worn down",
  WAVY: "long soft wavy hair worn loose",
...
// 미지 메이크업(2026-09-24 기준): 같은 사람으로 보이는 범위에서 연한 버전과 조금 진한 버전을 모두 쓴다.
export const MAKEUP = Object.freeze({
  LIGHT: "light natural makeup, soft skin",
  FRESH: "fresh minimal makeup, rosy cheeks",
  DEFINED: "slightly fuller makeup, defined eyeliner, soft rose lipstick",
});

export const GLOBAL_DIRECTION = Object.freeze({
  featured: { hair: HAIR.HALF, makeup: MAKEUP.LIGHT, camera: CAMERA.MEDIUM, viewpoint: VIEWPOINT.FRONT, posture: "standing, holding the document she is talking about" },
  context: { hair: HAIR.UPDO, makeup: MAKEUP.DEFINED, camera: CAMERA.WIDE, viewpoint: VIEWPOINT.THREE_QUARTER, posture: "walking through the space with a shoulder bag" },
  comparison: { hair: HAIR.DOWN, makeup: MAKEUP.FRESH, camera: CAMERA.LOW, viewpoint: VIEWPOINT.ANGLED_DOWN, posture: "seated at a table, comparing two items laid out in front of her" },
  checklist: { hair: HAIR.CAP, makeup: MAKEUP.LIGHT, camera: CAMERA.OVER_SHOULDER, viewpoint: VIEWPOINT.BACK, posture: "crouched beside an open case, working through it item by item" },
  closing: { hair: HAIR.WAVY, makeup: MAKEUP.DEFINED, camera: CAMERA.CLOSE, viewpoint: VIEWPOINT.PROFILE, posture: "pausing by a window, phone in hand" },
});
