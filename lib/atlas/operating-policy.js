...
export const ATLAS_POLICIES = Object.freeze([
  ...
  },
  {
    ...
    detail: "통합 화면의 자동 준비는 쿠팡 근거가 확인된 후보만 초안으로 만든다. 실제 발행은 제휴 링크·이미지가 있어야 한다.",
    enforcedBy: ["app/api/atlas/unified-publish/route.js#preparePair", "lib/atlas/korea-product-pipeline.js#publishBlockers"],
  },
]);
