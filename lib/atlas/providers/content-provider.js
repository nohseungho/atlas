...
} from "@/lib/atlas/character-channel-policy";
...
Hard rules:
- Channel identity is fixed: this is the global English Blogger channel and its presenter is Miji. Any visible presenter, woman or traveler in visualAssets must be Miji; never invent or substitute another recurring face.
- Domestic Korean/Naver assets and the Suho character are forbidden in this package.
